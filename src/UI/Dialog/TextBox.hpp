...
/**
 * Dialog for entering user defined strings.
 */
...
public:
     ...
     */
    TextBox( string && msg, string && check ) noexcept;
    
    /**
     * Copy constructor
     * @msg Information that will be shown in this dialog.
     */
    TextBox( const string & msg, const string & check );
    ...
    /**
     * Appends letter to input string.
     */
    void Append( int letter );

    /**
     * @return Reference to a final string that user submitted after leaving this dialog.
     */
